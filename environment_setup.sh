...
#USER CUSTOM#
################################
RUNID="XXXXX_XXXXX_XXXXX_XXXXX-XXXXX"
BINSIZE=50
REGEX="bam$"
...
PROV2="/.mounts/labs/seqprodbio/private/backups/seqware_files_report_latest.tsv.gz" #only meant for OICR
...
LIBID="LIBXXXXX"    # Unique library ID
